...
graphData *mainControl::process(QString strNumOfPeople, QString strPConstant, int resolution, int maxTime){
    ...
    //Gera os pontos
    for(counter = 0; counter < (unsigned int)maxTime; counter++){
